    ...
    return (
        <>
            <div className='d-flex justify-content-evenly pt-3' >
                {/* Home */}
                <NavLink to="/" className='d-flex flex-column align-items-center' style={{ cursor: "pointer" }}>
                ...
                {/* Sale */}
                <NavLink to='/route' className='d-flex flex-column align-items-center' style={{ cursor: "pointer" }}>
                ...
                <div className='d-flex flex-column align-items-center' style={{ cursor: "pointer" }}>
                    ...
                    <p style={{ fontSize: ".6rem" }}>Category</p>
                </div>
                ...
                <div className='d-flex flex-column align-items-center' style={{ cursor: "pointer" }}>
                    ...
                    <p style={{ fontSize: ".6rem" }}>Weather</p>
                </div>
